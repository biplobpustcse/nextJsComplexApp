...
const ProductInfoModel = ({ item = [], setProductData, section }) => {
                    ...
                    <div className="product-badget">
                      ...
                      itemContain?.discount_show == null
                        ? parseFloat(itemContain?.price) -
                          ...
                          " Tk"
                        : (itemContain?.discountPrice / itemContain?.price) *
                            100 +
                          " %"}{" "}
                      off
                    </div>
        ...
        <div className="single-celebration">
          <div className="celebration-flex">
            ...
            <div className="left-box">
              <img
                src={
                  item?.promotion_banner != null || item?.promotion_banner != ""
                    ? item?.promotion_banner.includes("placeholder")
                      ? item?.image
                      : item?.promotion_banner
                    : item?.photos.length > 0
                    ? item?.photos[0]
                    : ""
                }
              ...
              />
              {/*<img src="" alt="" className="img-fluid w-100 h-100"/>*/}
            </div>
              ...
              >
                <div className="more-options">
                  ...
                  <div className="all-more">
                    <div className="first-more" style={{ display: "none" }}>
                      <button
                        type="button"
                      ...
                      <div className="dropdown-menu">
                        <h4 className="product-name">
                          VVE Hilsha fish (1.6+kg)
                        </h4>
                        <div className="all-offer">
                          <p>
                            buy 1 get <span className="disc-qty">5%</span>
                            discount
                          </p>
                          <p>
                            buy 2 get <span className="disc-qty">8%</span>
                            discount
                          </p>
                          <p>
                            buy 1 get<span className="disc-qty">10%</span>
                            discount
                          </p>
                          <p>
                            buy 2 get <span className="disc-qty">5%</span>
                            discount
                          </p>
                        </div>
                      </div>
