...
import { getBrandStore } from "../../components/lib/endpoints";
...
function ShopProductShorting({
  ...
  useEffect(() => {
    if (renderPage == false) {
      setBreadCumb(
        JSON.parse(localStorage.getItem("dataBreadcumb")) == undefined
          ? []
          : JSON.parse(localStorage.getItem("dataBreadcumb"))
      );
      setRenderPage(true);
    }
            ...
            <div class="sorting-flex-main">
             ...
             <nav aria-label="breadcrumb" class="breadcrumbs medium-font">
                <ol class="breadcrumb">
                 ...
                 {
                  breadcumb.length > 0 &&   breadcumb.map((value) => {
                    return (
                      <li className="breadcrumb-item">
